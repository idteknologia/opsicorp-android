...
data class BookingResultReservationEntity(
	...
	val segments: List<SegmentsItemReservationEntity> = ArrayList(),
	...
	val remarks: List<Any> = ArrayList(),
	...
	val contact: ContactReservationEntity =ContactReservationEntity(),
