...
package com.opsigo.travelaja.module.item_custom.ticket_view;
...
public class TicketView extends View {
    ...
    public static final String TAG = com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.class.getSimpleName();

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.Orientation.HORIZONTAL, com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.Orientation.VERTICAL})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.DividerType.NORMAL, com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.DividerType.DASH})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.CornerType.NORMAL, com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.CornerType.ROUNDED})
    ...
    private void doLayout() {
        ...
        if (mOrientation == com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.Orientation.HORIZONTAL) {
            offset = ((top + bottom) / mScallopPosition) - mScallopRadius;

            if (mCornerType == com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.CornerType.ROUNDED) {
            ...
            } else if (mCornerType == com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.CornerType.SCALLOP) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mOrientation = typedArray.getInt(R.styleable.TicketView_ticketOrientation, com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.Orientation.HORIZONTAL);
            ...
            mDividerType = typedArray.getInt(R.styleable.TicketView_ticketDividerType, com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.DividerType.NORMAL);
            ...
            mCornerType = typedArray.getInt(R.styleable.TicketView_ticketCornerType, com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.CornerType.NORMAL);
    ...
    private void setDividerPaint() {
        ...
        if (mDividerType == com.opsigo.travelaja.module.item_custom.ticket_view.TicketView.DividerType.DASH)
