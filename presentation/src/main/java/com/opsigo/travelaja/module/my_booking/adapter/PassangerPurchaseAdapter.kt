...
class PassangerPurchaseAdapter (var context: Context, private var items: ArrayList<PassangerPurchaseModel>): RecyclerView.Adapter<PassangerPurchaseAdapter.ViewHolder>() {
