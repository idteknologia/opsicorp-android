...
class SelectReasonAdapter (context: Context, private var items: ArrayList<ReasonCodeModel>): androidx.recyclerview.widget.RecyclerView.Adapter<SelectReasonAdapter.ViewHolder>() {
