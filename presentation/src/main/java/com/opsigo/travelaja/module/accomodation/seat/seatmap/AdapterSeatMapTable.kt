package com.opsigo.travelaja.module.accomodation.seat.seatmap
...
class AdapterSeatMapTable (val context: Context, private var items: ArrayList<SeatTableModel>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
