package com.opsigo.travelaja.module.signin.select.adapter
...
class LookUpAdapter (private var items: ArrayList<SelectNationalModel>): androidx.recyclerview.widget.RecyclerView.Adapter<LookUpAdapter.ViewHolder>() {
