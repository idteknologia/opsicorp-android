...
import com.opsigo.travelaja.module.accomodation.train.dialog.TrainShortByDialog
...
import com.opsigo.travelaja.module.accomodation.train.filter.TrainFilterActivity
...
class ResultSearchTrainActivity : BaseActivity(),
    ...
    override fun getLayout(): Int { return R.layout.detail_search_train }
