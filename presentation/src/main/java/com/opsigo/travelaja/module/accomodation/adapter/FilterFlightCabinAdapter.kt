...
class FilterFlightCabinAdapter (val context: Context, private var items: ArrayList<FilterFlightModel>): RecyclerView.Adapter<FilterFlightCabinAdapter.ViewHolder>() {
