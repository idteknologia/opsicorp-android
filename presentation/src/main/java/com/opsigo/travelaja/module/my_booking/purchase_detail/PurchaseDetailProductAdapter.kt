...
class PurchaseDetailProductAdapter (var context: Context, private var items: ArrayList<PurchaseDetailProductModel>): RecyclerView.Adapter<PurchaseDetailProductAdapter.ViewHolder>() {
