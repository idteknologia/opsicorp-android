...
import com.opsigo.travelaja.module.accomodation.hotel.confirmation.ConfirmationOrderHotel
...
//        data.addAll(DataDummyAccomodation().addDataDummyRoom())
    ...
    fun selectDialogDuration(view: View){
        DialogSelectDuration(this).create(object :DialogSelectDurationHotel{
