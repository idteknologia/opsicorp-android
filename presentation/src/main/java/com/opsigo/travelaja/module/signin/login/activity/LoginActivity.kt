package com.opsigo.travelaja.module.signin.login.activity
...
import com.opsigo.travelaja.utility.Constants.RC_SIGN_IN
...
import com.opsigo.travelaja.module.signin.splash.activity.SplashActivity
import com.opsigo.travelaja.module.signin.login.presenter.LoginPresenter
import com.opsigo.travelaja.module.signin.register.RegisterWithEmailActivity
...
class LoginActivity : BaseActivity(),
    ...
    private fun getDataLogin() {
        showDialog("")
        GetDataLogin(MyURL.URL_TRAVELAJA).getDataLogin(et_username.text.toString(),et_password.text.toString(),object : CallbackLogin {
    ...
    private fun getConfig(token: String) {
        GetDataLogin(getBaseUrl()).getDataConfig(token,object : CallbackConfig {
            ...
            override fun successLoad(data: ConfigModel) {
                ...
                Globals.setDataPreferenceString(this@LoginActivity,"config",Serializer.serialize(data, ConfigModel::class.java))
                gotoSplashScreen()
...
//                    saveDataLogin(DataDummyUser().addLoginDummy2())
    ...
    fun initGoogleLogin(){
        val serverClientId = "370202765925-lucp63jthasvjivopvg88qg4daf7paa4.apps.googleusercontent.com"
