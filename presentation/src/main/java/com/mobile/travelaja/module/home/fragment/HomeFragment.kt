package com.mobile.travelaja.module.home.fragment
...
import com.mobile.travelaja.module.item_custom.slider.SliderImageOpsicorp
...
import com.mobile.travelaja.module.create_trip.newtrip.actvity.CreateTripActivity
import com.mobile.travelaja.module.home.activity.HomeWebActivity
...
//        initSlider()
    ...
    private fun setScheduleTripFirst(trip: Trip, itemView: View) {
        ...
        itemView.tvDestination.text = trip.nameCities()
        if (trip.isToday()) {
