package com.mobile.travelaja.module.signin.select.presenter
...
class LookUpPresenter :KoinComponent {
...
//    val adapter  by lazy { LookUpAdapter(getDataLogin)}
    val adapter by inject<LookUpAdapter> { parametersOf(data) }

    constructor(context: Context, view: LookUpView) {
