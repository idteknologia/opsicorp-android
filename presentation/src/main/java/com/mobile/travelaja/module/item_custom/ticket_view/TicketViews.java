...
public class TicketViews extends View {

    public static final String TAG = TicketViews.class.getSimpleName();

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({TicketViews.Orientation.HORIZONTAL, TicketViews.Orientation.VERTICAL})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({TicketViews.DividerType.NORMAL, TicketViews.DividerType.DASH})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({TicketViews.CornerType.NORMAL, TicketViews.CornerType.ROUNDED})
    ...
    public TicketViews(Context context) {
        super(context);
        init(null);
    }

    public TicketViews(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public TicketViews(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void doLayout() {
        ...
        if (mOrientation == TicketViews.Orientation.HORIZONTAL) {
            offset = ((top + bottom) / mScallopPosition) - mScallopRadius;

            if (mCornerType == TicketViews.CornerType.ROUNDED) {
            ...
            } else if (mCornerType == TicketViews.CornerType.SCALLOP) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mOrientation = typedArray.getInt(R.styleable.TicketView_ticketOrientation, TicketViews.Orientation.HORIZONTAL);
            ...
            mDividerType = typedArray.getInt(R.styleable.TicketView_ticketDividerType, TicketViews.DividerType.NORMAL);
            ...
            mCornerType = typedArray.getInt(R.styleable.TicketView_ticketCornerType, TicketViews.CornerType.NORMAL);
    ...
    private void setDividerPaint() {
        ...
        if (mDividerType == TicketViews.DividerType.DASH)
