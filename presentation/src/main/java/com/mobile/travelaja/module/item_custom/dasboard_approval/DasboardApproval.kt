...
import com.mobile.travelaja.module.item_custom.button_top_filter_approval.ButtonTopFilterApproval
...
class DasboardApproval: LinearLayout, View.OnClickListener,ButtonTopFilterApproval.OnclickButtonApproval {
    ...
    private fun init() {
        ...
        View.inflate(context, R.layout.list_month_approval, this)
...
/*        tv_waiting_for_approval.text     = data.waitingApprofal
    ...
    fun animateCountTextView(textView: CountAnimationTextView,string: String){
        textView
