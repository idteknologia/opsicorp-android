...
import com.opsicorp.hotel_feature.adapter.HotelShorByAdapter
import com.opsigo.travelaja.utility.OnclickListenerRecyclerView

class HotelShortByDialog(var context: Context) {
    ...
    val adapterShortBy by lazy { HotelShorByAdapter(context,data) }
    ...
    fun create(currentSort: Int,callbackDialog: CallbackDialog){
        ...
        views = LayoutInflater.from(context).inflate(R.layout.hotel_short_by_dialog,null)
