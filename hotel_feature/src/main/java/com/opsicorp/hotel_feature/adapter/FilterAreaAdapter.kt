...
class FilterAreaAdapter (context: Context, private var items: ArrayList<String>): androidx.recyclerview.widget.RecyclerView.Adapter<FilterAreaAdapter.ViewHolder>() {
